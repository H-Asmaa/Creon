...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body suppressHydrationWarning={true} className='w-screen h-screen margin-0 top-0'>
        <header className="fixed bg-black flex justify-between z-50 w-full h-16">
          <div className="w-auto h-full ml-6 mt-2 z-50">
            <Link href='/'>
              <Image
                src={CreonLogo}
                alt="Creon logo"
          ...
          <button className={`z-50 ${!navVisible ? '' : 'hidden transform -translate-y-full transition-transform duration-500 ease-in-out'}`} onClick={toggleNav}>
            <div className="border border-white rounded-md p-2.5 m-[10px] ml-6">
              <Menu />
            </div>
          </button>
          {navVisible && <nav className={`bg-black w-auto h-screen z-50 ${navVisible ? '' : 'hidden transform -translate-y-full transition-transform duration-500 ease-in-out'}`}>
            <div className='flex justify-end'>
              <button onClick={toggleNav} >
                <div className="border border-white rounded-md p-2.5 m-[10px] ml-6 hover:bg-blue-500 transition-colors duration-200">
                  <X />
                </div>
              </button>
            </div>
            ...
            <div className="flex justify-center align-center h-[50px]">
        ...
        <footer className="p-2 text-white flex flex-col md:flex-row justify-evenly">
